...
為了營造開放且熱情的環境，貢獻者和維護者承諾讓參與專案和社群成為每個人都能免受騷擾的體驗。 此保證不分年齡、體型、殘疾、種族、性別認同和性別表現、經驗程度、國籍、個人外貌、種族、宗教或性認同和性取向。
...
專案維護人員有權移除、編輯或拒絕不符合本行為準則的評論、認可、程式碼、Wiki編輯和問題，並且有責任加以拒絕。 或者，暫時或永久禁止任何他們認為不合適、具威脅、冒犯或有害行為的貢獻者。
