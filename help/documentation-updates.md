...
## [!DNL Adobe Experience Manager] 作為 [!DNL Cloud Service] {#aem-cloud-service}
...
| 2020 年 4 月 9 日 | 使用 Brand Portal 設定 [!DNL Experience Manager Assets] as a [!DNL Cloud Service] | [!DNL Experience Manager Assets] as a [!DNL Cloud Service] 現在支援 Brand Portal。您可以配置Brand Portal租戶 [!DNL Experience Manager Assets] 作為 [!DNL Cloud Service] Adobe I/O。<br>- [配置 [!DNL Assets] 作為 [!DNL Cloud Service] 與Brand Portal](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html)<br>- [將資產發佈到Brand Portal](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/assets/brand-portal/publish-to-brand-portal.html) |
