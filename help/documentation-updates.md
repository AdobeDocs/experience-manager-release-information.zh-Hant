...
>
>如需了解個別發行版 (目前和先前版本) 的相關文件，請參閱[版本注意事項](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)。
