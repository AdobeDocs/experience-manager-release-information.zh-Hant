...
本頁列出自新年開始以來Adobe Experience Manager的重要檔案變更和更新。
...
| 2020 年 9 月 24 日 | 在 Dynamic Media 中使用選擇性發佈 | 您可以在資料夾層級選擇從Experience Manager或Dynamic Media發佈或取消發佈資產。 您需使用「管理出版物」或「快速發佈」來完成此工作，而非僅能依賴在Dynamic Media執行個體使用相同資料夾設定的Dynamic Media組態。<br>請參閱[在 Dynamic Media 中使用選擇性發佈](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/selective-publishing.html?lang=en)。 |
...
| 2020 年 7 月 15 日 | Sling 速查表 | [Sling速查表](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/sling-cheatsheet.html?lang=en)已更新為參考[HTL。](https://experienceleague.adobe.com/docs/experience-manager-htl/using/overview.html?lang=en) |
...
| 2020 年 6 月 19 日 | Experience Manager | Adobe旨在在在程式碼、檔案和體驗中使用公平的術語。<br>因此，本檔案集已更新。 |
...
| 2020 年 6 月 4 日 | 使用Brand Portal將Experience Manager資產設定為Cloud Service | Adobe I/O 已升級並品牌化為 Adobe Developer Console，具備全新的使用者介面和工作流程。說明檔案會根據最新的「Adobe開發人員控制台」工作流程更新，以[將Experience Manager資產設定為Brand Portal的Cloud Service。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html?lang=en) |
| 2020 年 6 月 1 日 | RTF 編輯器 (RTE) | 下列RTF編輯器(RTE)相關文章適用於Adobe Experience Manager as aCloud Service:<br>- [設定RTE](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/rich-text-editor.html?lang=en)<br>- [設定每個外掛程式](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/configure-rich-text-editor-plug-ins.html?lang=en)<br>- [設定RTE以建立無障礙頁面](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/rte-accessible-content.html?lang=en)<br>- [ — 使用RTE](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/rich-text-editor.html?lang=en)製作內容 |
| 2020 年 5 月 29 日 | 核心元件 | 核心元件 2.9.0 版推出 Adobe Client 資料層整合與新的進度欄元件，並且提供 Authoring 說明文件和開發人員詳細資訊，並可透過 GitHub 下載專案。 |
| 2020 年 5 月 19 日 | 協助工具及 WCAG 2.1 指南 | 針對WCAG 2.1指南進行更新：<br>- [Adobe Experience Manager as aCloud Service和網頁協助工具指南](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/compliance/accessibility/web-accessibility.html?lang=en)<br>- [ WCAG 2.1](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/compliance/accessibility/quick-guide-wcag.html?lang=en)<br>- [建立無障礙內容(WCAG 2.1一致性](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/accessible-content.html?lang=en) |
| 2020 年 5 月 4 日 | Dynamic Media 不支援的影像格式 | Dynamic Media不支援點陣影像檔案格式子類型的相關資訊。<br>請參閱 [Dynamic Media 不支援的光柵影像格式。](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/assets-formats.html?lang=en) |
| 2020 年 4 月 20 日 | 內容片段 | 關於Experience Manager資產HTTP API](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/assets-api-content-fragments.html?lang=en)中[內容片段支援，以及[自訂和延伸內容片段](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-customizing.html?lang=en)和[內容片段的演算設定元件的資訊。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-configuring-components-rendering.html?lang=en) |
| 2020 年 4 月 9 日 | 使用Brand Portal將Experience Manager資產設定為Cloud Service | Brand Portal現在支援以Experience Manager資產作為Cloud Service。 您可以設定具有Experience Manager資產作為Adobe I/OCloud Service的Brand Portal租戶：<br>- [使用Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html?lang=en)<br>- [將Experience Manager資產設定為Cloud Service，將資產發佈至Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/publish-to-brand-portal.html?lang=en) |
| 2020 年 4 月 9 日 | Adobe Asset Link v2.0 已推出 | Adobe資產連結2.0支援與多個Adobe Experience Manager環境搭配使用，並支援以Experience Manager作為Cloud Service。 Experience Manager可支援行銷人員，協助他們在以AAL將資產上傳至資料夾時，設定自動執行資產處理工作流程。 <br> 請參閱 [Adobe 資產連結。](https://helpx.adobe.com/tw/enterprise/using/adobe-asset-link.html) |
| 2020 年 3 月 24 日 | 設定 Dynamic Media Cloud Service | 設定Dynamic MediaCloud Service時有新選項可用：<br>**選擇性發佈** — 選取此選項時，表示資產會發佈並僅限安全預覽，而且無須發佈至DMS7供公共網域傳送，即可明確發佈至Experience Manager。<br>請參閱[設定 Dynamic Media Cloud Service。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/config-dm.html?lang=en) |
| 2020 年 3 月 2 日 | Dynamic Media - 智慧型裁切 | 在Dynamic Media元件中使用智慧型裁切的新選項：<br>**啟用長寬比符合** — 選取此選項，讓Dynamic Media挑選最符合原始影像長寬比的智慧型裁切轉譯。<br>請參閱[當您使用智慧型裁切時。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/adding-dynamic-media-assets-to-pages.html?lang=en) |
| 2020 年 2 月 25 日 | 角色型權限 | Cloud Manager 已預先設定角色，賦予適當權限。每個角色都有與每個角色相關聯的特定權限、預先設定的任務或權限。 [角色型權限](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/what-is-required/role-based-permissions.html?lang=en) 頁面會列出可用的函式以及可執行此函式的角色。 |
...
| 2020 年 9 月 3 日 | Experience Manager 6.5 Service Pack 6 | [Experience Manager6.5 Service Pack 6](https://docs.adobe.com/content/help/zh-Hant/experience-manager-65/release-notes/service-pack/sp-release-notes.html) 可供使用。 |
...
| 2020 年 7 月 15 日 | Sling 速查表 | [Sling速查表](https://docs.adobe.com/content/help/zh-Hant/experience-manager-65/developing/platform/sling-cheatsheet.html)已更新為參考[HTL。](https://docs.adobe.com/content/help/zh-Hant/experience-manager-htl/using/overview.html) |
| 2020 年 6 月 19 日 | Adobe Experience Manager | Adobe旨在在在程式碼、檔案和體驗中使用公平的術語。<br>因此，本說明檔案集已進行一系列更新，以反映此權益。 |
| 2020 年 6 月 4 日 | 使用Brand Portal設定Experience Manager資產 | Adobe I/O 已升級並品牌化為 Adobe Developer Console，具備全新的使用者介面和工作流程。說明檔案已根據最新的「Adobe開發人員主控台」工作流程完成更新，以使用Brand Portal設定Experience Manager資產：<br>- [使用Brand Portal設定Experience Manager資產](https://docs.adobe.com/content/help/zh-Hant/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html)<br>- [升級舊組態以Adobe開發人員主控台](https://docs.adobe.com/content/help/zh-Hant/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html#upgrade-integration-65) |
| 2020 年 6 月 4 日 | Experience Manager 6.5 Service Pack 5 | [Experience Manager6.5 Service Pack 5](https://docs.adobe.com/content/help/en/experience-manager-65/release-notes/service-pack/sp-release-notes.html) 已推出。 |
| 2020 年 5 月 25 日 | 協助工具及 WCAG 2.1 指南 | 針對WCAG 2.1指南進行更新：<br>- [Adobe Experience Manager as aCloud Service和網頁協助工具指南](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/onboarding/accessibility/web-accessibility.html)<br>- [ WCAG 2.1](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/onboarding/accessibility/quick-guide-wcag.html)<br>- [建立無障礙內容(WCAG 2.1一致性](https://docs.adobe.com/content/help/zh-Hant/experience-manager-cloud-service/sites/authoring/fundamentals/accessible-content.html) |
| 2020 年 4 月 13 日 | 資產版本設定 | 更新如何建立、預覽和回復至[Experience Manager中資產版本的內容和影片。](https://docs.adobe.com/content/help/zh-Hant/experience-manager-65/assets/managing/managing-assets-touch-ui.html#asset-versioning) |
...
| 2020 年 3 月 5 日 | Experience Manager 6.5 Service Pack 4 | [Experience Manager6.5 Service Pack 4](https://docs.adobe.com/content/help/zh-Hant/experience-manager-65/release-notes/sp-release-notes.html) 可供使用。 |
...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 2020 年 11 月 26 日 | Experience Manager 6.4 Service Pack 8 Cumulative Fix Pack 3 | [Experience Manager6.4 Service Pack 8 Cumulative Fix Pack 3](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/cfp-release-notes.html) 可供使用。 |
| 2020 年 9 月 3 日 | Experience Manager 6.4 Service Pack 8 Cumulative Fix Pack 2 | [Experience Manager6.4 Service Pack 8 Cumulative Fix Pack 2](https://docs.adobe.com/content/help/zh-Hant/experience-manager-64/release-notes/cfp-release-notes.html) 已推出。 |
...
| 2020 年 6 月 19 日 | Adobe Experience Manager | Adobe旨在在在程式碼、檔案和體驗中使用公平的術語。<br>因此，本說明檔案集已進行一系列更新，以反映此權益。 |
| 2020 年 6 月 4 日 | Experience Manager 6.4 Service Pack 8 Cumulative Fix Pack 1 | [Experience Manager6.4 Service Pack 8 Cumulative Fix Pack 1](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html) 已推出。 |
...
| 2020 年 3 月 5 日 | Experience Manager 6.4 Service Pack 8 | [Experience Manager6.4 Service Pack 8](https://docs.adobe.com/content/help/zh-Hant/experience-manager-64/release-notes/sp-release-notes.html) 可供使用。 |
...
| 2020 年 3 月 5 日 | Experience Manager 6.3.3.8 | [適用於Experience Manager6.3的Cumulative Fix Pack 6.3.3.8](https://helpx.adobe.com/tw/experience-manager/release-notes--aem-6-3-cumulative-fix-pack.html) 已推出。 |
