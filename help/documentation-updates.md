...
| 日期 | 主題 | 變更 |
| --- | --- | --- |
| 2021 年 11 月 04 日 | AEM with Dynamic Media — 智慧型裁切 | 使用最新的Adobe Sensei服務，改善影像資產的智慧型裁切和智慧型色票。 檔案更新包含下列項目：<br>·新 **[!UICONTROL 跨目標解析度保留裁切內容]** 選項。<br>·當您手動重新對齊或調整多個資產的智慧型裁切視窗大小時，即使您稍後決定重新處理這些資產，這些編輯內容仍會保留和保留。 不過，如果您在 **[!UICONTROL 回應式影像裁切]** 影像設定檔的區域，則這些資產會重新處理。<br>·智慧型裁切和色票支援的全新影像檔案格式表。<br>請參閱 [影像設定檔](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/image-profiles.html) 以取得這些更新。 |
| 2021 年 11 月 03 日 | 智慧型裁切視訊檢視器API | 新增 [智慧型裁切視訊檢視器API檔案現已推出](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/viewers-for-aem-assets-only/smartcropvideo/c-html5-aem-smartcropvideo-viewer-reference.html?lang=en) (位於Dynamic Media檢視器參考指南中)。 |
