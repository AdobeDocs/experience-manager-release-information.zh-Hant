...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
          ...
          <div style="margin: 10px 0;"><b>JEE 上的 AEM Forms 修補安裝程式</b></div>
    ...
    <tr>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
          ...
          <div style="margin: 10px 0;"><b>Forms Designer 32 位元修補安裝程式</b></div>
    ...
    6-5-0-20230913-1-12345 <br/><p>AEM Forms JEE 修補安裝程式：aemforms-6-5-0-0069<br/><p>AEM Forms 增益集套件：6.5.18.0 </p></td>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
      ...
      <td><p>AEM Forms JEE 安裝程式：AEMForms-6-5-0-0065<br/><p>AEM Forms 增益集套件：6.0.968</p></td>
    </tr>
     <tr>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
      ...
      <td><p>AEM Forms JEE 安裝程式：AEMForms-6.5.0-0053<br /> <p>AEM Forms 增益集套件：6.0.772</p></td>
    </tr>
     <tr>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div> 
      ...
      <td><p>AEM Forms JEE 安裝程式：AEMForms-6.5.0-0044<br /> <p>AEM Forms 增益集套件：6.0.718</p></td>
    </tr>
     <tr>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
          ...
          <div style="margin: 10px 0;"><b>JEE 上的 AEM Forms 完整安裝程式</b></div>
     ...
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：AEMForms-6.5.0-0037<br /> </p> AEM Forms 增益集套件：6.0.566</p> <p>用戶端 SDK：6.0.566<br /></td>
    </tr>
     <tr>
      ...
      <td>
        <ul>
          ...
          <li><a href="https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/featurepack/livecycle-embed-pkg-5.0.18.zip">JEE 上的 AEM Forms 嵌入套件</a></li>
          <b style="display:block; margin:10px 0;">JEE 修補安裝程式</b>
     ...
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：AEMForms-6.5.0-0025<br /> </p> AEM Forms 增益集套件：6.0.334</p> <p>AEM Forms 相容性套件：2.0.36</p><p>Client SDK：6.0.334<br /> </p><p>AEM Forms Designer 修補程式：650.014</p></td>
    </tr>
     <tr>
     ...
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：6.5.0-0018<br /> </p> AEM Forms 增益集套件：6.0.192</p> <p>Client SDK：6.0.192<br /> </p> <p>AEM Forms Designer 修補程式：650.012<br /> </p> </td>
    </tr>
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：6.5.0-0014<br /> </p> <p>AEM Forms 增益集套件：6.0.160</p> <p>Client SDK：6.0.160<br /> </p> <p>AEM Forms Designer 修補程式：650.008<br /> </p> </td>
    </tr>
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：6.5.0-0011<br /> </p> <p>AEM Forms 相容性套件：2.0.26<br /> AEM Forms 增益集套件：6.0.138</p> <p>Client SDK：6.0.136<br /> </p> <p>AEM Forms Workbench：6.5.0.20191119.1.935956<br /> </p> </td>
    </tr>
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：6.5.0-0007</p> <p>AEM Forms 相容性套件：2.0.26</p> <p>AEM Forms 增益集套件和用戶端 SDK：6.0.122</p> <p>AEM Forms Workbench：6.5.0.20191119.1.935956</p> </td>
    </tr>
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：6.5.0-0004_3</p> <p>AEM Forms 相容性套件：2.0.22</p> <p>AEM Forms 增益集套件和用戶端 SDK：6.0.106</p> <p>AEM Forms Workbench：6.5.0.20190917.1.337048</p> </td>
    </tr>
     <tr>
      ...
      <td><p>AEM Forms JEE 安裝程式：6.5.0-0004</p> <p>AEM Forms Designer 修補程式：6.5.0-005</p> <p>AEM Forms 相容性套件：<strong></strong>1.1.16</p> <p>AEM Forms 增益集套件：6.0.88</p> </td>
    </tr>
     <tr>
    ...
    <td>AEM 6.5</td>
      ...
      <td><p>AEM Forms 增益集套件和用戶端 SDK：6.0.80</p> <p>AEM Websphere® 全域安全設定套件：6.5.0.20190329.1.935745</p> <p>AEM Forms 應用程式來源：5.0.16</p> <p> </p> </td>
    </tr>
  </tbody>
 </table>
