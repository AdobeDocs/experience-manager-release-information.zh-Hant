...
<table>
  ...
  <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65-lts/content/release-notes/release-notes">AEM 6.5 LTS Forms Service Pack 1</a></td>
    <td><a href="https://experienceleague.adobe.com/zh-hant/docs/experience-manager-65-lts/content/release-notes/release-notes">AEM 6.5 LTS Forms Service Pack 1</a></td>
    <td>
     <ul>
     <div style="margin: 10px 0;"><b>OSGi 完整安裝程式上的 AEM Forms 6.5 LTS</b></div>
    ...
    <td><p>AEM Forms 6.5 LTS 套件附加元件：6.1.176 <br/></p><!--<p>AEM Forms 6.5 LTS Compatibility Package:-->  </td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
      ...
      <div style="margin: 10px 0;"><b>Forms Designer 64 位元修補安裝程式</b></div>
  ...
  <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
      ...
      <div style="margin: 10px 0;"><b>Workbench 安裝程式</b></div>
  ...
  <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
      ...
      <div style="margin: 10px 0;"><b>Forms Designer 64 位元完整安裝程式</b></div>
   ...
   <tr>
    ...
    <td>
     ...
     <div style="margin: 10px 0;"><b>AEM Forms on OSGi 修補安裝程式</b></div>
      ...
      <div style="margin: 10px 0;"><b>Forms Designer 修補安裝程式</b></div>
   ...
   <tr>
    ...
    <td>
     <ul>
      ...
      <div style="margin: 10px 0;"><b>JEE 修補安裝程式</b></div>
