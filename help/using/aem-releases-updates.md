...
針對 Managed Services 和內部部署產品，本文列出最新 Cumulative Fix Pack 版本、最新服務包版本及主要版本，並導向您前往這些版本的說明文件。 [!DNL Adobe] 建議您查看並套用最新服務包，接著套用您 [!DNL Experience Manager] 版本的最新 Cumulative Fix Pack，確保部署穩定、安全且為最新狀態。

### [!DNL Experience Manager] 6.5 {#aem-65}

[!DNL Experience Manager] 6.5 產品更新會透過 Service Pack 提供，內容包括新功能、增強功能和錯誤修正。
...
[!DNL Experience Manager] 6.5 LTS 產品更新會透過 Service Pack 提供，內容包括新功能、增強功能和錯誤修正。
